...
/**
 * The /demo holding page (bead hq-wrig5.8). Every demo button on the site
 * carries a placeholder path until the demo host is live; before then the
 * button lands here rather than on the 404 page. The page says the demos are
 * not open yet, names the three modules, and points the reader at the modules
 * page, the pricing page and the free diagnostic. It carries a noindex
 * directive: this is a holding page and not one we want found.
 */
